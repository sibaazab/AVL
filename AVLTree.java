...
public class AVLTree {
    ...
    /**
     * private LinkedList</Integer> inOrder
     *
     * @param root
     * @param l
     * @return : linkedList sorted by the keys value (in order traversals)
     */


    private LinkedList<Integer> inOrder(AVLNode root, LinkedList<Integer> l){
    ...
    public int[] keysToArray()
    {
        ...
        if (empty())
            ...
            Iterator<Integer> t = temp.descendingIterator();
    ...
    private LinkedList<String> inOrderInfo(AVLNode root, LinkedList<String> l){
        if (root.left == null && root.right == null)
            l.add(root.info);
        else{
            inOrderInfo(root.left,l);
            l.add(root.info);
            inOrderInfo(root.right,l);
        }
        return l;
    }
    ...
    public String[] infoToArray()
    {
        ...
        temp = inOrderInfo(root,temp);
        String[] values = new String[this.size];
        if (empty())
            return values;
        else {
            Iterator<String> t = temp.descendingIterator();
            for (int i=0; i<this.size;i++){
                values[i] = t.next();
            }
        }
